...
-- Usando IDs numéricos: 9=Sevilla, 10=Jerez, 11=Puerto
-- =====================================================

-- Tabla principal de revisiones trimestrales de mantenimiento
CREATE TABLE IF NOT EXISTS quarterly_maintenance_reviews (
  id BIGSERIAL PRIMARY KEY,
  center_id BIGINT NOT NULL REFERENCES centers(id), -- 9=Sevilla, 10=Jerez, 11=Puerto
...
-- Tabla de asignaciones de revisiones de mantenimiento
CREATE TABLE IF NOT EXISTS quarterly_maintenance_assignments (
  id BIGSERIAL PRIMARY KEY,
  review_id BIGINT NOT NULL REFERENCES quarterly_maintenance_reviews(id) ON DELETE CASCADE,
  center_id BIGINT NOT NULL REFERENCES centers(id), -- 9=Sevilla, 10=Jerez, 11=Puerto
  center_name TEXT NOT NULL,
  assigned_to TEXT,
...
-- Tabla de items de revisión de mantenimiento
CREATE TABLE IF NOT EXISTS quarterly_maintenance_items (
  id BIGSERIAL PRIMARY KEY,
  assignment_id BIGINT NOT NULL REFERENCES quarterly_maintenance_assignments(id) ON DELETE CASCADE,
...
-- Tabla de notificaciones de mantenimiento (para incidencias con plazo)
