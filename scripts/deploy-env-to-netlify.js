...
// Paso 7: Redeploy
log('\n🔄 Redesplegando sitio con nuevas variables...', 'cyan');
...
try {
  ...
  warning('No se pudo hacer redeploy automático');
  info('Puedes hacerlo manualmente desde Netlify Dashboard');
}
...
log('2. Espera a que el deploy se complete');
