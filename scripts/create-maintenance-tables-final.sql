...
-- Script final - sin validaciones de referencias
-- =====================================================
...
SELECT 'quarterly_maintenance_reviews' as table_name, COUNT(*) as records FROM quarterly_maintenance_reviews
UNION ALL
SELECT 'quarterly_maintenance_assignments', COUNT(*) FROM quarterly_maintenance_assignments
UNION ALL
SELECT 'quarterly_maintenance_items', COUNT(*) FROM quarterly_maintenance_items
UNION ALL
SELECT 'maintenance_review_notifications', COUNT(*) FROM maintenance_review_notifications;
