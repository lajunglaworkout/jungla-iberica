...
const CENTERS: Record<CenterKey, { subdomain: string; passwordEnvKey: string }> = {
    sevilla: { subdomain: "jungla",             passwordEnvKey: "WODBUSTER_PASSWORD_SEVILLA" },
    jerez:   { subdomain: "lajunglajerez",      passwordEnvKey: "WODBUSTER_PASSWORD_JEREZ"   },
    puerto:  { subdomain: "lajunglaelpuerto",   passwordEnvKey: "WODBUSTER_PASSWORD_PUERTO"  },
};
