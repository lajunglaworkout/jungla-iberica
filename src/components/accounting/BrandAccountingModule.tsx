...
import SalesLeadsModule from '../sales/SalesLeadsModule';
...
const BrandAccountingModule: React.FC<BrandAccountingModuleProps> = ({ onBack }) => {
  ...
  // Si estamos en el módulo de ventas, mostrar ese componente
  if (activeModule === 'sales') {
    return <SalesLeadsModule onBack={() => setActiveModule('dashboard')} />;
  }
