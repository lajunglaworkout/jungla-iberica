...
import QuarterlyMaintenanceSystemWithSupabase from './logistics/QuarterlyMaintenanceSystemWithSupabase';
      ...
      <div style={{ padding: '0 2rem' }}>
        ...
        <div style={{ display: 'flex', borderBottom: '1px solid #e5e7eb', marginBottom: '2rem' }}>
          {[
            ...
            { id: 'maintenance', label: '🔧 Mantenimiento Trimestral', icon: Settings, permission: 'canViewReports' },
        ...
        {/* Pestaña Mantenimiento Trimestral */}
        {activeTab === 'maintenance' && currentUser.permissions.canViewReports && (
