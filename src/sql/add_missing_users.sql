...
INSERT INTO employees (name, email, role, base_role, center_id, assigned_modules, is_active)
SELECT 'Javier Surian', 'javier.sevilla@lajungla.es', 'Entrenador', 'trainer', '2', ARRAY[]::TEXT[], true
WHERE NOT EXISTS (
    SELECT 1 FROM employees WHERE email = 'javier.sevilla@lajungla.es'
);

INSERT INTO employees (name, email, role, base_role, center_id, assigned_modules, is_active)
SELECT 'Jesús Rosado', 'jesus.rosado@lajungla.es', 'Entrenador', 'trainer', '2', ARRAY[]::TEXT[], true
WHERE NOT EXISTS (
    SELECT 1 FROM employees WHERE email = 'jesus.rosado@lajungla.es'
);

INSERT INTO employees (name, email, role, base_role, center_id, assigned_modules, is_active)
SELECT 'Jesús Arias', 'jesus.arias@lajungla.es', 'Entrenador', 'trainer', '2', ARRAY[]::TEXT[], true
WHERE NOT EXISTS (
    SELECT 1 FROM employees WHERE email = 'jesus.arias@lajungla.es'
);

INSERT INTO employees (name, email, role, base_role, center_id, assigned_modules, is_active)
SELECT 'Santi Frías', 'santi.sevilla@lajungla.es', 'Entrenador', 'trainer', '2', ARRAY[]::TEXT[], true
WHERE NOT EXISTS (
...
-- Empleados de Jerez
INSERT INTO employees (name, email, role, base_role, center_id, assigned_modules, is_active)
SELECT 'Rodri', 'rodri.jerez@lajungla.es', 'Entrenador', 'trainer', '3', ARRAY[]::TEXT[], true
WHERE NOT EXISTS (
    SELECT 1 FROM employees WHERE email = 'rodri.jerez@lajungla.es'
);

INSERT INTO employees (name, email, role, base_role, center_id, assigned_modules, is_active)
SELECT 'Mario', 'mario.jerez@lajungla.es', 'Entrenador', 'trainer', '3', ARRAY[]::TEXT[], true
WHERE NOT EXISTS (
    SELECT 1 FROM employees WHERE email = 'mario.jerez@lajungla.es'
);

INSERT INTO employees (name, email, role, base_role, center_id, assigned_modules, is_active)
SELECT 'Antonio', 'antonio.jerez@lajungla.es', 'Entrenador', 'trainer', '3', ARRAY[]::TEXT[], true
WHERE NOT EXISTS (
    SELECT 1 FROM employees WHERE email = 'antonio.jerez@lajungla.es'
);

INSERT INTO employees (name, email, role, base_role, center_id, assigned_modules, is_active)
SELECT 'Fran', 'fran.jerez@lajungla.es', 'Entrenador', 'trainer', '3', ARRAY[]::TEXT[], true
WHERE NOT EXISTS (
...
-- Empleados de Puerto
INSERT INTO employees (name, email, role, base_role, center_id, assigned_modules, is_active)
SELECT 'José', 'jose.puerto@lajungla.es', 'Empleado', 'employee', '4', ARRAY[]::TEXT[], true
WHERE NOT EXISTS (
    SELECT 1 FROM employees WHERE email = 'jose.puerto@lajungla.es'
);

INSERT INTO employees (name, email, role, base_role, center_id, assigned_modules, is_active)
SELECT 'Keko', 'keko.puerto@lajungla.es', 'Empleado', 'employee', '4', ARRAY[]::TEXT[], true
WHERE NOT EXISTS (
    SELECT 1 FROM employees WHERE email = 'keko.puerto@lajungla.es'
);

INSERT INTO employees (name, email, role, base_role, center_id, assigned_modules, is_active)
SELECT 'Jonathan', 'jonathan.puerto@lajungla.es', 'Empleado', 'employee', '4', ARRAY[]::TEXT[], true
WHERE NOT EXISTS (
    SELECT 1 FROM employees WHERE email = 'jonathan.puerto@lajungla.es'
);

INSERT INTO employees (name, email, role, base_role, center_id, assigned_modules, is_active)
SELECT 'Fran', 'fran.puerto@lajungla.es', 'Empleado', 'employee', '4', ARRAY[]::TEXT[], true
WHERE NOT EXISTS (
